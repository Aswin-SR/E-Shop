    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <Grid container
                ...
                <Typography sx={{ position: 'relative', fontSize: 20 }}>Sign up</Typography>
            </Grid>
            ...
            <Grid container xs={12}>
                ...
                <FormControl sx={{ m: 1, width: '25%', paddingLeft: '37%' }}>
                    <TextField required id="outlined-required" label="Contact Number" />
                </FormControl>
                ...
                <Grid item xs={12} />
                <FormControl sx={{ m: 1, width: '25%', paddingLeft: '47%' }}>
                <Link to='/Login'><Button sx={{ backgroundColor: 'white', color: 'Blue', textDecoration: 'underline', textTransform: 'none' }}>
